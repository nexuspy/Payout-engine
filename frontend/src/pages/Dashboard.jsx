...
const Dashboard = () => {
  ...
  const handlePayout = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(`${API_BASE}/merchants/${selectedMerchant.id}/payouts/create/`, {
  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-12 gap-10">
        <motion.div className="col-span-8 bg-neutral-pop rounded-6xl p-14 shadow-organic-lg emerald-mesh relative overflow-hidden group">
          <div className="relative z-10">
            <div className="flex justify-between items-start mb-16">
              <div>
                ...
                <h4 className="text-8xl font-extrabold text-forest-deep hero-text tracking-tighter leading-none mb-6">
                  {formatPaise(balances.available_paise)}
                </h4>
              ...
              <div className="w-20 h-20 bg-forest-deep rounded-[2.5rem] flex items-center justify-center text-white shadow-2xl mt-4">
          ...
          <div className="absolute -right-32 -bottom-20 w-80 h-80 bg-emerald-light/10 blur-[100px] rounded-full"></div>
        </motion.div>

        <div className="col-span-4 flex flex-col gap-10">
          <div className="flex-1 bg-forest-deep rounded-5xl p-10 relative overflow-hidden shadow-2xl">
            <p className="text-emerald-light/60 text-xs font-bold mb-4 uppercase tracking-widest">Awaiting Settlement</p>
            <h4 className="text-4xl font-extrabold text-white hero-text mb-4">{formatPaise(balances.held_paise)}</h4>
          ...
          <div className="flex-1 bg-neutral-well rounded-5xl p-10 border border-white">
            <p className="text-slate-400 text-xs font-bold mb-4 uppercase tracking-widest">Total Cleared</p>
            <h4 className="text-4xl font-extrabold text-forest-deep hero-text mb-4">{formatPaise(balances.cleared_paise)}</h4>
      ...
      <div className="grid grid-cols-12 gap-12 items-start">
        <section className="col-span-8 bg-neutral-pop rounded-6xl p-12 shadow-organic-lg border border-slate-50">
            ...
            <tbody>
              {payouts.slice(0, 4).map(p => (
                <tr key={p.id} className="border-b border-slate-50 last:border-0">
                  <td className="py-6 font-bold text-forest-deep">{p.bank_account_name}</td>
        ...
        <section className="col-span-4 bg-neutral-pop rounded-6xl p-12 border border-slate-100 shadow-organic-lg">
          ...
          <form onSubmit={handlePayout} className="space-y-8">
            <div>
              ...
              <input 
                ...
                className="w-full bg-neutral-well/50 rounded-2xl p-6 text-2xl font-extrabold text-forest-deep"
                placeholder="0.00"
              />
            </div>
            <div>
              ...
              <select 
                ...
                className="w-full bg-neutral-well/50 rounded-2xl p-5 text-sm font-bold"
              >
            ...
            <button className="w-full bg-forest-deep text-white font-black py-6 rounded-3xl shadow-xl">
